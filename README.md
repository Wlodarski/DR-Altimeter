...
- **[Top right y axis (altitude) : scale not formatted](https://github.com/Wlodarski/DR-Altimeter/issues/1)**  
  ...
  - The definitive solution is to wait for the [matplotlib](https://matplotlib.org/) library to updated (correction scheduled to be included with version 0.3.30), `pip install --upgrade matplotlib`
